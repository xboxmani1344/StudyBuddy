...
app.listen(PORT, () => {
  ...
  if (!process.env.OPENROUTER_API_KEY) {
    console.warn(
      `Note: no OpenRouter API key yet. You don't need to edit any files — open http://localhost:${PORT} and paste your key into the setup screen. Get a free one at https://openrouter.ai/keys`
    );
  }
